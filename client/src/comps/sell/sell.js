      ...
      if(error === false && inputBlankError === false){
          fetch("/api/products/", {
              ...
              .then(res => res.json().then(data => {
                  if(data.status === 201) navigator(`/product/${data.product._id}`, {state: {item : data.product} });
               }
    ...
    <div id="sell-page">
      <form id="sell-form">
        <div id="error-show" className={error ? "showErr" : "hideErr"}>
          <p>Must select at least one pic/Number of images cannot surpass 6</p>
        </div>
        <div id="error-show" className={inputBlankError ? "showErr" : "hideErr"}>
        ...
        <span className="sell-form-item"  >
          ...
          <select
            ...
            onChange={(e)=> handleInput(e)}
          >
            <option value="--categoire--" disabled>--choose a categoire--</option>
        ...
        <span className="sell-form-item">
          ...
          <select
            ...
            onChange={(e)=> handleInput(e)}
          >
            <option value="--region--" disabled>--choose a region--</option>
